...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
        private void aggMet(ActionEvent event) throws IOException
    {
         try {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/it.edu.gastaldiabba.rubrica.view.FXMLAggiungi.fxml"));
